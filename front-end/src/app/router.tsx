  ...
  createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: paths.app.alarms.path,
          lazy: () => import('./routes/app/alarms').then(convert(queryClient)),
        },
        {
        ...
        {
          path: paths.app.testing.path,
          lazy: () =>
            import('./routes/app/testing/testing').then(convert(queryClient)),
        },
      ],
    },
    {
