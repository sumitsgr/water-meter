import { require_react } from './chunk-ZDUQQDQL.js';
import { __commonJS, __toESM } from './chunk-QWN5BXRD.js';
...
function createBrowserHistory(options = {}) {
  function createBrowserLocation(window2, globalHistory) {
    var _a;
    let maskedLocation =
      (_a = globalHistory.state) == null ? void 0 : _a.masked;
...
function createRouter(init) {
  ...
  async function callDataStrategy(
    ...
    if (!isMutationMethod(request.method)) {
      for (let match of matches) {
        if (
          ((_a = results[match.route.id]) == null ? void 0 : _a.type) ===
          'error'
        ) {
          break;
        }
...
function dataWithResponseInitToErrorResponse(data2) {
  ...
  return new ErrorResponseImpl(
    ...
    ((_b = data2.init) == null ? void 0 : _b.statusText) ??
    ...
    dataRouterState && onErrorHandler
      ? (error, errorInfo) => {
          ...
          onErrorHandler(error, {
            ...
            params:
              ((_b = (_a = dataRouterState.matches) == null ? void 0 : _a[0]) ==
              null
                ? void 0
                : _b.params) ?? {},
      ...
      if (newErrors && onError) {
        Object.values(newErrors).forEach((error) => {
          ...
          return onError(error, {
            ...
            params:
              ((_a = newState.matches[0]) == null ? void 0 : _a.params) ?? {},
    ...
    (error, errorInfo) => {
      ...
      if (
        ...
        dataRouterContext.onError(error, {
          ...
          params:
            ((_a = dataRouterStateContext.matches[0]) == null
              ? void 0
              : _a.params) || {},
      ...
      for (let match of matches) {
        if (match.route.id in fetchedData.routes) {
          ...
          if ('error' in routeResult) {
            ...
            if (
              ((_a = results[match.route.id]) == null ? void 0 : _a.result) ==
              null
            ) {
              results[match.route.id] = {
                type: 'error',
    ...
    if (routerRef.current == null) {
      frameworkContextRef.current = {
        future: {
          ...
          v8_middleware:
            (future == null ? void 0 : future.v8_middleware) === true,
  ...
  let forwardedHostValue =
    (_a =
      forwardedHostHeader == null
        ? void 0
        : forwardedHostHeader.split(',')[0]) == null
      ? void 0
      : _a.trim();
...
function getNormalizedPath(request, basename, future) {
  ...
  if (
    future == null ? void 0 : future.unstable_trailingSlashAwareDataRequests
  ) {
...
async function routeRSCServerRequest({
  ...
  try {
    ...
    if (
      ...
      return new Response(
        (serverResponseB == null ? void 0 : serverResponseB.body) || '',
        {
          headers: headers2,
...
react-router/dist/development/chunk-RMD3H4O3.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HJZKBXAB.js.map
