...
var _client,
  ...
  _initialIsOpen,
  _errorTypes,
  _hideDisabledQueries,
  _Component,
  _theme,
  _dispose,
  _a;
var TanstackQueryDevtools =
  ((_a = class {
    constructor(config) {
      ...
      __privateSet(
        this,
        _hideDisabledQueries,
        createSignal(hideDisabledQueries),
      );
    ...
    mount(el) {
      ...
      const dispose = render(() => {
        ...
        if (__privateGet(this, _Component)) {
          ...
          Devtools = lazy(() => import('./VKXKX7EQ-DL4CSV3G.js'));
          __privateSet(this, _Component, Devtools);
        }
        setupStyleSheet(
          __privateGet(this, _styleNonce),
          __privateGet(this, _shadowDOMTarget),
        );
  ...
  (_hideDisabledQueries = new WeakMap()),
...
var _client2,
  ...
  _initialIsOpen2,
  _errorTypes2,
  _hideDisabledQueries2,
  _onClose,
  _Component2,
  _theme2,
  _dispose2,
  _a2;
var TanstackQueryDevtoolsPanel =
  ((_a2 = class {
    constructor(config) {
    ...
    mount(el) {
      ...
      const dispose = render(() => {
        ...
        if (__privateGet(this, _Component2)) {
          ...
          Devtools = lazy(() => import('./ZUJJ2RGI-2C5TOOM3.js'));
          __privateSet(this, _Component2, Devtools);
        }
        setupStyleSheet(
          __privateGet(this, _styleNonce2),
          __privateGet(this, _shadowDOMTarget2),
        );
        return createComponent(
          Devtools,
          mergeProps(
  ...
  (_hideDisabledQueries2 = new WeakMap()),
