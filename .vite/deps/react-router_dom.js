'use client';
import { require_react_dom } from './chunk-5DGLZQX2.js';
import {
...
} from './chunk-HJZKBXAB.js';
import { require_react } from './chunk-ZDUQQDQL.js';
import { __toESM } from './chunk-QWN5BXRD.js';
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    var _a, _b;
    if (
      routeDiscovery.mode === 'initial' || // @ts-expect-error - TS doesn't know about this yet
  ...
  return React3.createElement(
    ...
    React3.createElement(
      ...
      React3.createElement(
        ...
        React3.createElement(RouterProvider, {
...
function createRouteFromServerManifest(match, payload) {
  ...
  let hasInitialError =
    (payload == null ? void 0 : payload.errors) && match.id in payload.errors;
  let initialError =
    (_a = payload == null ? void 0 : payload.errors) == null
      ? void 0
      : _a[match.id];
  let isHydrationRequest =
    ((_b = match.clientLoader) == null ? void 0 : _b.hydrate) === true ||
